...
var _ShadowOnScrollDirective = class _ShadowOnScrollDirective {
  ...
  set cShadowOnScroll(value) {
    ...
    if (value) {
      ...
      __privateSet(this, _observable, (0, import_rxjs2.fromEvent)(__privateGet(this, _document), "scroll").pipe(takeUntilDestroyed(__privateGet(this, _destroyRef))).subscribe((scrolled) => {
...
var _BackdropService = class _BackdropService {
  constructor() {
    ...
    __privateSet(this, _backdropClick, new import_rxjs2.Subject());
...
var _BreadcrumbRouterService = class _BreadcrumbRouterService {
  constructor(router, route) {
    ...
    this.route = route;
    this.outlet = "primary";
    __privateSet(this, _breadcrumbsBehaviorSubject, new import_rxjs2.BehaviorSubject(new Array()));
    this.breadcrumbs$ = __privateGet(this, _breadcrumbsBehaviorSubject).asObservable();
    this.router.events.pipe(takeUntilDestroyed(), (0, import_operators2.filter)((event) => event instanceof NavigationEnd)).subscribe((event) => {
      const breadcrumbs = [];
...
var _BreadcrumbRouterComponent = class _BreadcrumbRouterComponent {
  ...
  setup() {
    if (this.items && this.items.length > 0) {
      this.breadcrumbs = new import_rxjs2.Observable((observer) => {
        if (this.items) {
...
var _IntersectionService = class _IntersectionService {
  constructor() {
    ...
    __privateSet(this, _intersecting, new import_rxjs2.BehaviorSubject({
...
var _LocalStorageService = class _LocalStorageService {
  constructor(platformId, document2) {
    ...
    this.document = document2;
    __privateSet(this, _data$, new import_rxjs2.BehaviorSubject(null));
...
var _ColorModeService = class _ColorModeService {
  constructor() {
    ...
    afterNextRender({
      read: () => {
        this.localStorageItemName$.pipe((0, import_operators2.tap)((params) => {
...
var _CarouselService = class _CarouselService {
  constructor() {
    this.carouselIndex = new import_rxjs2.BehaviorSubject({});
...
var _CarouselComponent = class _CarouselComponent {
  ...
  intersectionServiceSubscribe() {
    ...
    this.intersectionService.intersecting$.pipe((0, import_operators2.filter)((next) => next.hostElement === this.hostElement), (0, import_operators2.finalize)(() => {
  ...
  swipeSubscribe(subscribe = true) {
    if (this.touch && subscribe) {
      ...
      const touchStart$ = (0, import_rxjs2.fromEvent)(carouselElement, "touchstart");
      const touchEnd$ = (0, import_rxjs2.fromEvent)(carouselElement, "touchend");
      const touchMove$ = (0, import_rxjs2.fromEvent)(carouselElement, "touchmove");
      this.swipeSubscription = touchStart$.pipe((0, import_operators2.zipWith)(touchEnd$.pipe((0, import_operators2.withLatestFrom)(touchMove$))), takeUntilDestroyed(__privateGet(this, _destroyRef3))).subscribe(([touchstart, [touchend, touchmove]]) => {
...
var _DropdownService = class _DropdownService {
  constructor() {
    this.dropdownState = new import_rxjs2.BehaviorSubject({});
...
var _DropdownMenuDirective = class _DropdownMenuDirective {
  ...
  ngAfterContentInit() {
    ...
    this.dropdownItemsContent.changes.pipe((0, import_operators2.tap)((change) => {
      this.focusKeyManagerInit();
    }), takeUntilDestroyed(__privateGet(this, _destroyRef4))).subscribe();
  }
  ngOnInit() {
    __privateGet(this, _dropdownService).dropdownState$.pipe((0, import_operators2.tap)((state2) => {
...
var _DropdownComponent = class _DropdownComponent {
  ...
  dropdownStateSubscribe(subscribe = true) {
    if (subscribe) {
      this.dropdownStateSubscription = this.dropdownService.dropdownState$.pipe((0, import_operators2.filter)((state2) => {
...
var _ModalService = class _ModalService {
  constructor() {
    this.modalState = new import_rxjs2.Subject();
...
var _OffcanvasService = class _OffcanvasService {
  constructor() {
    this.offcanvasState = new import_rxjs2.Subject();
...
var _OffcanvasComponent = class _OffcanvasComponent {
  ...
  layoutChangeSubscribe(subscribe = true) {
    if (subscribe) {
      ...
      __privateSet(this, _layoutChangeSubscription, layoutChanges.pipe((0, import_operators2.filter)((breakpointState) => !breakpointState.matches), takeUntilDestroyed(__privateGet(this, _destroyRef7))).subscribe((breakpointState) => {
...
var _PopoverDirective = class _PopoverDirective {
  ...
  intersectionServiceSubscribe() {
    this.intersectionService.createIntersectionObserver(this.hostElement);
    this.intersectionService.intersecting$.pipe((0, import_operators2.filter)((next) => next.hostElement === this.hostElement), (0, import_operators2.debounceTime)(100), (0, import_operators2.finalize)(() => {
      this.intersectionService.unobserve(this.hostElement);
...
var _renderer4, _hostElement2, _max, _min, _value, _width, _valuesEffect;
    ...
    __privateSet(this, _valuesEffect, effect(() => {
      ...
      if (__privateGet(this, _value).call(this) === void 0 || __privateGet(this, _width).call(this)) {
        for (let name of ["aria-valuenow", "aria-valuemax", "aria-valuemin", "role"]) {
          __privateGet(this, _renderer4).removeAttribute(host, name);
        }
      } else {
        __privateGet(this, _renderer4).setAttribute(host, "aria-valuenow", String(__privateGet(this, _value).call(this)));
        __privateGet(this, _renderer4).setAttribute(host, "aria-valuemin", String(__privateGet(this, _min)));
        __privateGet(this, _renderer4).setAttribute(host, "aria-valuemax", String(__privateGet(this, _max).call(this)));
        __privateGet(this, _renderer4).setAttribute(host, "role", this.role);
      }
      const tagName = host.tagName;
      if (this.percent() && (this.stacked && tagName === "C-PROGRESS" || !this.stacked && tagName !== "C-PROGRESS")) {
        __privateGet(this, _renderer4).setStyle(host, "width", `${this.percent()}%`);
      } else {
        __privateGet(this, _renderer4).removeStyle(host, "width");
      }
    }));
    this.precision = 0;
    this.stacked = false;
...
var _SidebarService = class _SidebarService {
  constructor() {
    this.sidebarState = new import_rxjs2.BehaviorSubject({});
...
var _SidebarNavGroupService = class _SidebarNavGroupService {
  constructor() {
    this.sidebarNavGroupState = new import_rxjs2.BehaviorSubject({});
...
var _SidebarNavLinkComponent = class _SidebarNavLinkComponent {
  ...
  constructor(router) {
    ...
    this.navigationEndObservable = router.events.pipe((0, import_operators2.filter)((event) => {
...
var _SidebarNavGroupComponent = class _SidebarNavGroupComponent {
  constructor(router, renderer, hostElement, helper, sidebarNavGroupService) {
    ...
    this.navigationEndObservable = router.events.pipe((0, import_operators2.filter)((event) => event instanceof NavigationEnd));
  }
  get hostClasses() {
    return {
      "nav-group": true,
...
var _TabService = class _TabService {
  constructor() {
    this.activeTabPaneIdx = new import_rxjs2.Subject();
  ...
  constructor() {
    ...
    this.disabledEffect = effect(() => {
      if (!__privateGet(this, _disabled).call(this)) {
        const click$ = (0, import_rxjs2.fromEvent)(__privateGet(this, _elementRef6).nativeElement, "click");
        const focusIn$ = (0, import_rxjs2.fromEvent)(__privateGet(this, _elementRef6).nativeElement, "focusin");
        (0, import_rxjs2.merge)(focusIn$, click$).pipe((0, import_operators2.filter)(($event) => !__privateGet(this, _disabled).call(this)), (0, import_operators2.tap)(($event) => {
          __privateGet(this, _tabsService).activeItemKey.set(untracked(this.itemKey));
        }), (0, import_rxjs2.takeWhile)(() => !__privateGet(this, _disabled).call(this)), takeUntilDestroyed(__privateGet(this, _destroyRef9))).subscribe();
      }
    }, {
      allowSignalWrites: true
    });
...
var _TabsListComponent = class _TabsListComponent {
  constructor() {
    ...
    this.tabsEffect = effect(() => {
      ...
      __privateGet(this, _focusKeyManager2).change.pipe((0, import_operators2.tap)((value) => {
...
var _ToasterService = class _ToasterService {
  constructor() {
    this.toasterState = new import_rxjs2.BehaviorSubject({});
...
var _TooltipDirective = class _TooltipDirective {
  ...
  intersectionServiceSubscribe() {
    ...
    this.intersectionService.intersecting$.pipe((0, import_operators2.filter)((next) => next.hostElement === this.referenceRef()), (0, import_operators2.debounceTime)(100), (0, import_operators2.finalize)(() => {
