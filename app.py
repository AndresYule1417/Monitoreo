...
app.config['MAIL_USERNAME'] = 'hidricosrecursos1@gmail.com'
app.config['MAIL_PASSWORD'] = 'vsnw lbwh xscv tcea'
app.config['MAIL_DEFAULT_SENDER'] = 'hidricosrecursos1@gmail.com'
mail = Mail(app)
